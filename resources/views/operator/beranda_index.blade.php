                ...
                <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            ...
                            <a href="{{ route('tagihan.index') }}" class="btn btn-sm btn-outline-primary">Lihat
                                Data
                                Pembayaran</a>
                        </div>
                    </div>
                        ...
                        <ul class="list-group">
                            @foreach ($tagihanBelumBayar->take(5) as $item)
                                <li class="list-group-item border-0 d-flex justify-content-between ps-0 border-radius-lg">
                                    ...
                                    <div class="d-flex">
                                        <a href="{{ route('tagihan.show', [$item->id, 'siswa_id' => $item->siswa_id, 'tahun' => $item->tanggal_tagihan->year]) }}"
                                            class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i
