<div class="bs-stepper-header">
    <div class="step {{ $activeStep1 ?? '' }}" data-target="#account-details">
        <a href="{{ route('tagihanlainstep.create', ['step' => 1]) }}" class="step-trigger">
    ...
    <div class="step {{ $activeStep2 ?? '' }}" data-target="#personal-info">
        <a href="{{ route('tagihanlainstep.create', ['step' => 2]) }}" class="step-trigger">
    ...
    <div class="step {{ $activeStep3 ?? '' }}" data-target="#social-links">
        <a href="{{ route('tagihanlainstep.create', ['step' => 3]) }}" class="step-trigger">
    ...
    <div class="step {{ $activeStep4 ?? '' }}" data-target="#social-links">
        <a href="{{ route('tagihanlainstep.create', ['step' => 4]) }}" class="step-trigger">
