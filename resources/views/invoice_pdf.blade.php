        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td class="title" width="80" style="margin-bottom: 0; padding-bottom: 0;">
                    ...
                    @if (request('output') == 'pdf')
                        <img src="{{ storage_path() . '/app/' . settings('app_logo') }}" alt="" width="70">
                    @else
                        <img src="{{ \Storage::url(settings('app_logo')) }}" alt="" width="70">
                    @endif
            ...
            @foreach ($tagihan->tagihanDetails as $item)
                <tr class="item" style="outline: thin solid">
                    ...
                    <td style="text-align: left">{{ $item->nama_biaya }}</td>
                    <td style="text-align: right">{{ formatRupiah($item->jumlah_biaya) }}</td>
                </tr>
            @endforeach
