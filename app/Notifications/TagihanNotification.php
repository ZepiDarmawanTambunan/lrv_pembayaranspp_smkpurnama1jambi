...
class TagihanNotification extends Notification
{
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'title' => 'Tagihan SPP Bulan '.$this->tagihan->siswa->nama ,
    ...
    public function toWhacenter($notifiable)
    {
        ...
        return (new WhacenterService())
            ...
            ->line('Berikut kami kirim informasi tagihan SPP untuk bulan '.$this->tagihan->tanggal_tagihan->translatedFormat('F').' atas nama '
